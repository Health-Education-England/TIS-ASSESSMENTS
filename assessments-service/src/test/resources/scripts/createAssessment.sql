...
VALUES
(1, 8502, 'FirstName1', 'LastName1', NULL, 'PROG1', 'ProgName1', 'COMPLETED', 'ARCP', '111111111', CURRENT_TIMESTAMP(3), 6242, NULL),
(2, 9017, 'FirstName2', 'LastName2', NULL, 'PROG2', 'ProgName2', 'COMPLETED', 'ARCP', '222222222', CURRENT_TIMESTAMP(3), 937, NULL);
...
VALUES
(1, 149, 'CurricName1', NULL, NULL, NULL, NULL, NULL, NULL, 'ST1', 'STT1', NULL, NULL, NULL, 0, 36, 'LDN/111/111/C', CURRENT_TIMESTAMP(3), 0, '111111111', NULL, 247),
(2, 261, 'CurricName2', NULL, NULL, NULL, NULL, NULL, NULL, 'ST1', 'STT1', NULL, NULL, NULL, 0, 0, 'LDN/222/222/C', CURRENT_TIMESTAMP(3), NULL, '222222222', NULL, 247);
...
VALUES
(1, '1', 0, '', NULL, NULL, 0, 0, 0, NULL, 0, NULL, '333333333', NULL, NULL, 'NA', NULL, NULL, NULL, NULL, NULL, 'ST7', CURRENT_TIMESTAMP(3), 0, NULL, 2, NULL, 343),
(2, '5', 0, '', NULL, NULL, 0, 0, 0, NULL, 0, NULL, '444444444', NULL, NULL, 'NA', 'NA', 'NA', 'NA', NULL, 'Record keeping and evidence. ', NULL, CURRENT_TIMESTAMP(3), 0, NULL, 6, NULL, NULL);

INSERT INTO `Revalidation` (`id`, `concernSummary`, `responsibleOfficerComments`, `amendedDate`, `intrepidId`, `knownConcerns`)
VALUES
(1, NULL, NULL, CURRENT_TIMESTAMP(3), '111111111', 0),
(2, NULL, NULL, CURRENT_TIMESTAMP(3), '222222222', 0);
