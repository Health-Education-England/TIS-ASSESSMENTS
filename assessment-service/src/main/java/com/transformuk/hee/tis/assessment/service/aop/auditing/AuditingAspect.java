package com.transformuk.hee.tis.assessment.service.aop.auditing;
...
import com.transformuk.hee.tis.assessment.service.repository.JsonPatchRepository;
...
public class AuditingAspect {
  ...
  private final static String PROFILE_PREFIX = "assessment_";
   ...
   */
  @Pointcut("execution(* com.transformuk.hee.tis.assessment.service.api.*.create*(..))")
   ...
   */
  @Pointcut("execution(* com.transformuk.hee.tis.assessment.service.api.*.update*(..))")
   ...
   */
  @Pointcut("execution(* com.transformuk.hee.tis.assessment.service.api.*.delete*(..))")
   ...
   */
  @Before("execution(* com.transformuk.hee.tis.assessment.service.api.*.update*(..))")
