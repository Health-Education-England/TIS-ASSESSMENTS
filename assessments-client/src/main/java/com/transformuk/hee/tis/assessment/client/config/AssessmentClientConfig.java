package com.transformuk.hee.tis.assessment.client.config;
...
public class AssessmentClientConfig {
   ...
   * @return
   */
  public RestTemplate defaultAssessmentRestTemplate() {
   ...
   * @return
   */
  public RestTemplate prodAssessmentRestTemplate(Keycloak keycloak) {
   ...
   * @return
   */
  public RestTemplate prodBrowserInitiatedAssessmentRestTemplate() {
